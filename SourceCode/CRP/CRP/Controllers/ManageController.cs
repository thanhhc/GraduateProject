...
namespace CRP.Controllers
{
	...
	public class ManageController : BaseController
	{
		...
		//
		// GET: /Manage/Index
		public async Task<ActionResult> Index(bool isSuccess = true, string statusMessage = null)
		{
			//ViewBag.StatusMessage =
			//    message == ManageMessageId.ChangePasswordSuccess ? "Đổi password thành công"
		...
		public ActionResult ChangePassword(string statusMessage = null)
		{
		...
		public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
		{
			...
			if (result.Succeeded)
			{
				...
				return RedirectToAction("Index", new {isSuccess = true, statusMessage = "Thay đổi mật khẩu thành công."});
			}

			return RedirectToAction("ChangePassword", new { statusMessage = result.Errors.ToList()[0] });
		}
		...
		public async Task<ActionResult> SetPassword(SetPasswordViewModel model)
		{
			if (ModelState.IsValid)
			{
				var result = await UserManager.AddPasswordAsync(User.Identity.GetUserId(), model.Password);
				if (result.Succeeded)
				{
					var user = await UserManager.FindByIdAsync(User.Identity.GetUserId());
					if (user != null)
